...
const CASOS = [
  // ===================== NIVEL 1 · 3×3 =====================
  {
    ...
    declaraciones: {
      gl: ["Eu só pasaba por aquí saltando.", "Eu tiña moita fame esta mañá.", "Eu estaba na lagoa, de verdade."],
      es: ["Yo solo pasaba por aquí saltando.", "Yo tenía mucha hambre esta mañana.", "Yo estaba en la charca, de verdad."],
    },
    pistas: {
      gl: ["A pata Rosa non comía cenorias nin mazás.", "O porco Tomás non comía cenorias."],
      es: ["La pata Rosa no comía zanahorias ni manzanas.", "El cerdo Tomás no comía zanahorias."],
    },
    restricciones: [["neg", 2, 0], ["neg", 2, 1], ["neg", 1, 0]],
    solucion: [0, 1, 2],
    culpable: 0,
